            ...
            <div class="glass-panel p-8 w-full max-w-md">
                ...
                <form id="register-form" class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="name" required class="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-accent">
                    </div>
                    <div>
                    ...
                    <p class="text-center text-gray-400 mt-4">
                        Already have an account? <a href="/login.html" class="text-accent hover:underline">Login</a>
                    </p>
                </form>
            </div>
        </div>
